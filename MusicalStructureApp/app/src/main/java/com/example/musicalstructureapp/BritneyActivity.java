...
public class BritneyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_britney);
        ...
        homeImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mainActivty = new Intent (BritneyActivity.this , MainActivity.class);
        ...
        stopImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(BritneyActivity.this, "Stop playing song", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        pauseImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(BritneyActivity.this, "Pause song", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        playImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(BritneyActivity.this, "Play song", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
